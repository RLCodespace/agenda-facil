...
const AGENDAMENTOS: Agendamento[] = [
  { id: 1, cliente: "João Pedro", servico: "Corte + Barba", data: "21/09, 14:00", status: "Confirmado" },
  ...
  { id: 5, cliente: "Diego Farias", servico: "Corte", data: "20/09, 17:00", status: "Concluído" },
